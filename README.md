sudo snap install anbox --edge --devmode && git clone --depth=1 https://github.com/thanasxda/anbox-modules-fix.git && cd anbox-modules-fix && sudo ./anbox_modules_fix.sh
